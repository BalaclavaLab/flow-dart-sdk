...
import '../entities/account.pb.dart' as $1;
import '../entities/event.pb.dart' as $2;
import '../entities/block_header.pb.dart' as $3;
...
class BlockHeaderResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BlockHeaderResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'flow.execution'), createEmptyInstance: create)
    ..aOM<$3.BlockHeader>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'block', subBuilder: $3.BlockHeader.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $3.BlockHeader get block => $_getN(0);
  @$pb.TagNumber(1)
  set block($3.BlockHeader v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasBlock() => $_has(0);
  @$pb.TagNumber(1)
  void clearBlock() => clearField(1);
  @$pb.TagNumber(1)
  $3.BlockHeader ensureBlock() => $_ensure(0);
}
